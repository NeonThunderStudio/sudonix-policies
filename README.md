# 📋 Instruções para Upload no GitHub Pages

## Arquivos Criados

✅ `data-deletion.html` - Página de exclusão de dados  
✅ `assets/neonthunder-logo.png` - Logo da NeonThunder Studio
...
2. Arraste o arquivo `data-deletion.html` da pasta `github-pages-upload`
3. Na mensagem de commit, escreva: `feat: adiciona página de exclusão de dados para Google Play`
4. Clique em **"Commit changes"**

### Passo 3: Upload do Logo
1. Navegue até a pasta **"assets"** no repositório (ou crie se não existir)
2. Clique em **"Add file"** → **"Upload files"**
3. Arraste o arquivo `neonthunder-logo.png` da pasta `github-pages-upload/assets`
4. Na mensagem de commit, escreva: `feat: adiciona logo da NeonThunder Studio`
...
## 🔗 URL para Usar no Google Play Console
...
- [ ] Upload de `data-deletion.html` concluído
- [ ] Upload de `assets/neonthunder-logo.png` concluído
- [ ] Aguardou 1-2 minutos para publicação
- [ ] Testou a URL no navegador
- [ ] Copiou a URL para o Google Play Console
...
5. Continue preenchendo o formulário
